...
public abstract class AICompatActivityAuthentication<P extends AICompatPresenterAuthentication> extends AICompatActivity<P> implements AIDelegatedAuthenticationVIew {
    private static final String TAG = AICompatActivityAuthentication.class.getSimpleName();
